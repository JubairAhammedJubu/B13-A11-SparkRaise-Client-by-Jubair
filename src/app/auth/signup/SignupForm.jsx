...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Image as ImageIcon, HeartHandshake, Rocket } from 'lucide-react';
...
// At least 6 characters, one letter and one number — "password strength" per doc requirement.
...
export default function SignupForm({ redirectTo = '/dashboard' }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error) {
        // Better Auth surfaces a duplicate-account error here (e.g. "already exists")
        toast.error(error.message || 'Signup failed. Please try again.');
        return;
      }

      const startingCredits = formData.role === 'creator' ? 20 : 50;
      toast.success(`Account created! You've got ${startingCredits} starting credits 🎉`);
          ...
          <div className="relative w-full md:w-1/2 h-48 md:h-auto overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
              ...
              <p className="text-white/90 text-sm md:text-base leading-relaxed max-w-[240px]">
                Back projects you believe in, or launch your own campaign.
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                Join SparkRaise as a Supporter or a Creator.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() =>
                    setFormData((prev) => ({...prev, role: "supporter"}))
                  }
