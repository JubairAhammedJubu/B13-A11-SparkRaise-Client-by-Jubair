...
import {
    ...
    Save, X, Upload, Loader2, Heart,
} from 'lucide-react';
import toast from 'react-hot-toast';
import { authClient } from '@/lib/auth-client';

export default function SupporterProfile({ user }) {
    ...
    return (
        <div className="p-6 pt-8 max-w-4xl mx-auto space-y-6 mt-16">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Supporter Profile</h1>
                    ...
                    >
                        ...
                        {imageTab === 'upload' ? (
                            <div
                                ...
                                className="border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-600 rounded-xl p-6 text-center cursor-pointer transition-all group"
                            >
                                <input
                                    ref={fileInputRef}
                                    type="file"
                                ...
                                <p className="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 transition-colors">
            ...
            >
                {[
                    ...
                    { icon: Heart, label: 'Account Role', value: '💜 Supporter', color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
                    { icon: Calendar, label: 'Member Since', value: joinDate, color: 'text-cyan-500', bg: 'bg-cyan-50 dark:bg-cyan-900/20' },
                ].map((item, i) => (
                    <div
                        key={i}
            ...
            >
                ...
                <div className="flex flex-wrap gap-3">
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800">
                        ...
                        <span className="text-xs font-medium text-indigo-600 dark:text-indigo-400">Active Supporter</span>
                    </div>
                    {user?.emailVerified && (
