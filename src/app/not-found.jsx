    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center py-6 px-4 overflow-hidden bg-gray-50 dark:bg-black">
      ...
      {mounted && (
        ...
        >
          ...
          >
            The page you&apos;re looking for has wandered off the syllabus. It
            may have been moved, deleted, or never written in the first place.
          </motion.p>
          ...
          >
            SparkRaise · Share Wisdom. Inspire Growth.
          </motion.p>
        </motion.div>
      )}
    </div>
